    ...
    createUI() {
      ...
      header.innerHTML = `
        ...
        <div class="dashboard-description">
          <p>This interactive dashboard visualizes the SCANDAT research group's analysis of 14,655 RBC transfusions in 6,736 ICU patients from four Stockholm-region hospitals (January 2014 – November 2018). In our study we examine how vital parameters change following transfusion and investigates whether variations in RBC component factors alter these trajectories.</p>
        </div>
      `;
