...
// Create header
      ...
      header.innerHTML = `
        ...
        <div class="dashboard-description">
          <p>This Transfusion Data Dashboard serves to communicate and interactively visualize the findings of the <span style="color: var(--accent-highlight);">SCANDAT</span> research group's analysis of 14,655 RBC transfusions in 6,736 unique ICU patients from four Stockholm-region hospitals between January 2014 – November 2018. In our study we examine how vital parameters change following RBC transfusions and investigate whether variations in RBC component factors alter these trajectories.</p>
        </div>
      `;
